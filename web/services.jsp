...
<html>
<head>
<title>AZD Company Pvt Ltd. | Services </title>
...
<div class="banner banner2">
	 <div class="container">
	     <div class="header">
			 <div class="logo">
				 <h1><a href="index.html"><img src="images/car.png" alt=""/>AZD <span>COMPANY</span></a></h1>
			 </div>
		 ...
		 <h2>Services</h2>
	    	...
	    	<div class="section group sec_group">
				<div class="col-md-6 service_sec">
				    ...
				    <div class="text list_2_of_1">
						<a href="modules/hr/hr_index.jsp" class="servicebutton">Human Resources</a></h3>
			...
			<div class="section group sec_group">
				<div class="col-md-6 service_sec">
				    ...
				    <div class="text list_2_of_1">
						<a href="modules/financial/fin_index.jsp" class="servicebutton">Financial</a></h3>
				...
				<div class="col-md-6 service_sec">
					...
					<div class="text list_2_of_1">
						  <a href="modules/distribution/dis_index.jsp" class="servicebutton">Distribution</a>
						  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt  ut labore et dolore.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
					</div>
					<div class="clearfix"></div>
				</div>
			...
			<div class="section group sec_group">
				<div class="col-md-6 service_sec">
				    ...
				    <div class="text list_2_of_1">
						<a href="modules/sales/sal_index.jsp" class="servicebutton">Sales and Services</a></h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt  ut labore et dolore.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
				   </div>
				   <div class="clearfix"></div>
			   </div>			
			 ...
			 <div class="col-md-4 ftr2-grid2">
				...
				<h3>Latest Tweets</h3>
				 <div class="ftr2-grid">
				  ...
				  <!-- Twitter Feed -->
				  <!-- Twitter Feed White-->
				  <!--<a class="twitter-timeline" href="https://twitter.com/AZDEngines" data-widget-id="650244166752931841">Tweets by @AZDEngines</a>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
			 ...
			 <div class="col-md-4 ftr6-grid3">
				 ...
				 <div class="social">
					   <ul>
							<li><a href="https://www.facebook.com/AZD-Racing-Engines-1527390010886102/timeline/"><i class="facebook"></i></a></li>
							<li><a href="https://twitter.com/AZDEngines"><i class="twitter"></i></a></li>
							<li><a href="https://plus.google.com/u/0/106640718142324511965/about"><i class="google"></i></a></li>										
					  </ul>
				 </div>
			 </div>
			 <div class="clearfix"></div>
