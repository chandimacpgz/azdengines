...
<body>
			...
			<div class="header_nav" id="home">
				<nav class="navbar navbar-default chn-gd">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<!---->
						<li class="col-md-2">
						<a href="dis_index.jsp" class="pink">
						...
						<!---->
						<li class="col-md-2">
						<a href="dis_about.jsp" class="orang">
						...
						<!---->
						<li class="col-md-2">
						<a href="dis_news.jsp" class="gray">
						...
						<!---->
						<li class="col-md-2">	
						<a href="dis_blog.jsp" class="green">
						<span class="glyphicon glyphicon-picture " aria-hidden="true"></span>
						Blog
						</a>
						</li>
						<li class="col-md-2">
						<a href="dis_contact.jsp" class="sky">
			...
			<div class="container">
				<div class="logo">
						<h1><a href="dis_index.jsp">Distribution</a></h1>
				</div>
				<div class="ad-ph">
