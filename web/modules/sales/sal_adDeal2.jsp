        ...
        <div class="container">
            <div class="col-md-6 news-left">
                <div class="news-right">
                    <p><h3><b>STEP 2</b></h3></p>
                    <h6><a href="#"> Deal of the - Add Image</a></h6>
                    <p>Include the latest arrivals of products to the stores. Can include three products.</p>
                    <form action="SalesDealAdImage" method="post" enctype="multipart/form-data">
                        ...
                        <table>
                            ...
                            <tr>
                                <th>Ad Image</th>
                                <td>&nbsp;&nbsp;</td>
                                <td><input type="file" name="AdImage" value=""></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                <th><input type="submit" value="Finish"></th>
