        ...
        <div class="container">
            <div class="col-md-6 news-left">
                <div class="news-right">
                    ...
                    <h6><a href="#">Slider Advertising</a></h6>
                    <p>Slider Ads.SIZE Should be 767x384 and there are four spots.</p>
                    <form action="../../SalesSlider1" method="post" enctype="multipart/form-data">

                        <div class="news-right">
                            <p> <h5><b> Slider 1 Image</b></h5><br>
                            <input type="file" name="SliderUpload1" id="SliderUpload1"></p>
                            <input type="submit" value="Upload Image" />
                        </div>
                    </form>
                    <form action="../../SalesSlider2" method="post" enctype="multipart/form-data">
                        <div class="news-right">
                            <p> <h5><b> Slider 2 Image</b></h5><br>
                            <input type="file" name="SliderUpload2"></p>
                            <input type="submit" value="Upload Image" />
                        </div>
                    </form>
                    <form action="../../SalesSlider3" method="post" enctype="multipart/form-data">
                        <div class="news-right">
                            <p> <h5><b> Slider 3 Image</b></h5><br>
                            <input type="file" name="SliderUpload3"></p>
                            <input type="submit" value="Upload Image" />
                        </div>
                    </form>
                    <form action="../../SalesSlider4" method="post" enctype="multipart/form-data">
                        <div class="news-right">
                            <p> <h5><b> Slider 4 Image</b></h5><br>
                            <input type="file" name="SliderUpload4"></p>
                            <input type="submit" value="Upload Image" />
                        </div>
                    </form>
                </div>
            ...
            <div class="col-md-6 news-left">
                <div class="news-right">
                    ...
                    <h6><a href="#"> New Arrivals Ads</a></h6>
                    <p>Include the latest arrivals of products to the stores. Can include three products.</p>
                    <form action="../../SalesNewArrivalAd1" method="post" enctype="multipart/form-data">

                        <div class="news-right">
                            <p> <h5><b> Top Selling Engine</b></h5><br>
                            <input type="file" name="SliderUpload1"></p>
                            <input type="submit" name="title" value="Upload Image" />
                        </div>
                    </form>
                    <form action="../../SalesNewArrivalAd2" method="post" enctype="multipart/form-data">
                        <div class="news-right">
                            <p> <h5><b> Latest Arrival</b></h5><br>
                            <input type="file" name="SliderUpload2"></p>
                            <input type="submit" value="Upload Image" />
                        </div>
                    </form>
                    <form action="../../SalesNewArrivalAd3" method="post" enctype="multipart/form-data">
                        <div class="news-right">
                            <p> <h5><b> Most Popular</b></h5><br>
                            <input type="file" name="SliderUpload3"></p>
                            <input type="submit" value="Upload Image" />
                        </div>
            ...
            <div class="col-md-6 news-left">
                <div class="news-right">
                    ...
                    <h6><a href="#">Deal of the Day</a></h6>
                    <p>Include the deal of the day with a expiration date with live countdown. Image should be of size 136x138.</p>
                    <form action="../../SalesDealAds" method="post" enctype="multipart/form-data">
                        
                        <h1>
                            <a href="sal_adDeal1.jsp"><span class="label label-danger">Deal Ad</span></a>
                        </h1>
            ...
            <div class="col-md-6 news-left">
                <div class="news-right">
                    ...
                    <h6><a href="#">Discount Ad</a></h6>
                    <p>Most important discount of the score. According to seasonal times. Emphasize with two words</p>
                    <form name="DiscountForm" onsubmit=" return validateform();
                        ...
                        <table>
                            <tr>
                                <th>Discount Name</th>
                                <td>&nbsp;&nbsp;</td>
                                <td><input type="text" name="DisAdTitle" value=""></td>
                            ...
                            <tr>
                                <th>Emphasized Name</th>
                                <td>&nbsp;&nbsp;</td>
                                <td><input type="text" name="DisEmpName" value=""></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td>&nbsp;&nbsp;</td>
                                <td><input type="text" name="DisValue" value=""></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                                <th><input type="submit" value="Submit" onclick="get_order(form)"></th>
