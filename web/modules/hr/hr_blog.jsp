...
<body>
			...
			<div class="header_nav" id="home">
				<nav class="navbar navbar-default chn-gd">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<!---->
						<li class="col-md-2">
						<a href="hr_index.jsp" class="pink">
						...
						<!---->
						<li class="col-md-2">
						<a href="hr_about.jsp" class="orang">
						...
						<!---->
						<li class="col-md-2">	
						<a href="hr_blog.jsp" class="green">
						<span class="glyphicon glyphicon-picture " aria-hidden="true"></span>
						Blog
						</a>
						</li>
						<li class="col-md-2">
						<a href="hr_contact.jsp" class="sky">
			...
			<div class="container">
				<div class="logo">
						<h1><a href="hr_index.jsp">Human Resources</a></h1>
				</div>
				<div class="ad-ph">
